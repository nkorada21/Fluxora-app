...
const Footer = () => {
  return (
    ...
    <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
        <div className="md:max-w-96">
            ...
            <p className="mt-6 text-sm">
                Fluxora AI helps creators and professionals work smarter with simple, powerful AI tools. 
                Write, design, and create with confidence.
            </p>
        </div>
    ...
    <p className="pt-4 text-center text-xs md:text-sm pb-5">
        Copyright 2025 © <a href="#"><span className='text-primary'>Fluxora AI</span></a>. All Right Reserved.
    </p>
</footer>
  )
}
