    ...
    return (
        <div className='px-4 sm:px-20 xl:px-32 py-24'>
            <div className='text-center'>
                <h2 className='text-slate-700 text-[42px] font-semibold'>What Our Users Are Saying</h2>
                <p className='text-gray-500 max-w-lg mx-auto'>Here’s what real users think about their experience with <span className='text-primary'>Fluxora</span>.</p>
            </div>
