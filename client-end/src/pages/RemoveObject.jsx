  ...
  const onSubmitHandler = async (e)=> {
    ...
    try {
      ...
      if(object.split(' ').length > 1) {
        return toast('Please enter a single object name for removal')
      }
    ...
    flex-wrap gap-4 text-slate-700'>
      ...
      border-gray-200'>
        ...
        <div className='flex items-center gap-3'>
          ...
          <h1 className='text-xl font-semibold'>Remove Unwanted Object</h1>
        </div>
        ...
        rounded-md border border-gray-300' placeholder='e.g., watch (single object only)' required/>
      ...
      border-gray-200 min-h-96'>
          ...
          </div>
          {
            ...
            <div className='text-sm flex flex-col items-center gap-5 text-gray-400'>
              ...
              <p className='w-full'> Start by uploading an image, then remove the unwanted object with a single click. </p>
            </div>
          </div>
            ) : (
