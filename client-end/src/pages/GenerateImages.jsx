    ...
    flex-wrap gap-4 text-slate-700'>
      ...
      border-gray-200'>
        <div className='flex items-center gap-3'>
          ...
          <h1 className='text-xl font-semibold'>Turn Your Ideas into Images</h1>
        </div>
        <p className='mt-6 text-sm font-medium'>Describe the image you want</p>
      ...
      border-gray-200 min-h-96'>
          <div className='flex items-center gap-3'>
            ...
            <h1 className='text-xl font-semibold'>Your AI-Created Image</h1>
          </div>
          {
            !content ? (
            ...
            <div className='text-sm flex flex-col items-center gap-5 text-gray-400'>
              ...
              <p> Start by entering a description, then let AI create the image for you. </p>
            </div>
          </div>
            ) : (
